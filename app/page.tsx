          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                ...
                <MagneticButton href="/resume.pdf" download className="px-6 py-3 border-2 border-warm-brown text-warm-brown dark:border-terracotta dark:text-terracotta rounded-lg hover:bg-warm-brown hover:text-white dark:hover:bg-terracotta transition-colors flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
