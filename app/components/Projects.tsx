            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-4 flex flex-wrap gap-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                    {project.liveDemo && (
                      <a
                        href={project.liveDemo}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-sm font-medium px-3 py-1.5 rounded-lg bg-warm-brown text-white dark:bg-terracotta hover:opacity-90 transition-opacity"
                      >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-warm-brown dark:text-terracotta hover:text-[#6B4F10] dark:hover:text-[#A06030] transition-colors text-sm font-medium"
                    >
